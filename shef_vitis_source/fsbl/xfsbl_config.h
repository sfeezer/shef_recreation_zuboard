...
#define FSBL_DEBUG_VAL              (1U)  /* Enabled for secure boot debugging */
#endif

#ifndef FSBL_DEBUG_INFO_VAL
#define FSBL_DEBUG_INFO_VAL         (1U)  /* Enabled for secure boot debugging */
#endif

#ifndef FSBL_DEBUG_DETAILED_VAL
#define FSBL_DEBUG_DETAILED_VAL     (1U)  /* Enabled for secure boot debugging */
#endif
