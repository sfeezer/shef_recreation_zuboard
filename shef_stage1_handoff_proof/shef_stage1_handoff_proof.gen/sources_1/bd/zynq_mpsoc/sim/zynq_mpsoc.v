...
//Date        : Sat Dec 20 13:57:50 2025
//Host        : DESKTOP-Q79VJS4 running 64-bit major release  (build 9200)
//Command     : generate_target zynq_mpsoc.bd
//Design      : zynq_mpsoc
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "zynq_mpsoc,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=zynq_mpsoc,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_zynq_ultra_ps_e_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "zynq_mpsoc.hwdef" *) 
module zynq_mpsoc
   ();

  wire zynq_ultra_ps_e_0_pl_clk0;

  zynq_mpsoc_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
