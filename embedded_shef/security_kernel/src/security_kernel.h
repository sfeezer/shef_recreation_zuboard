...
#define	XSECURE_AES_KEY	SHEF_AES_KEY
#define	XSECURE_IV	SHEF_AES_IV
#else
...
#ifdef SDT
#ifndef XPAR_XCSUDMA_0_BASEADDR
#error "XPAR_XCSUDMA_0_BASEADDR is missing from xparameters.h. Regenerate the BSP."
#endif
#define XSECURE_CSUDMA_DEVICEID	XPAR_XCSUDMA_0_BASEADDR
#else
#ifndef XPAR_XCSUDMA_0_DEVICE_ID
#error "XPAR_XCSUDMA_0_DEVICE_ID is missing from xparameters.h. Regenerate the BSP."
#endif
#define XSECURE_CSUDMA_DEVICEID	XPAR_XCSUDMA_0_DEVICE_ID
#endif

//DMA Channel 0
#define ADMA_CH0_BASE_ADDR SHEF_ADMA_CH0_BASE
...
//CSU and SSS config
#define CSU_BASE_ADDR SHEF_CSU_BASE
...
//PMU Registers
#define PMU_GLOBAL_BASE_ADDR SHEF_PMU_GLOBAL_BASE
...
//GPIO registers
#define GPIO_MASK_DATA_5_MSW ( (SHEF_GPIO_BASE) + 0x0000002CU )
#define GPIO_MASK_DIRM       ( (SHEF_GPIO_BASE) + 0x00000344U )
#define GPIO_OEN_5           ( (SHEF_GPIO_BASE) + 0x00000348U )
#define GPIO_DATA_5          ( (SHEF_GPIO_BASE) + 0x00000054U )
